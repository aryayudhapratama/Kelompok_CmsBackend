        ...
        <div class="row justify-content-between mb-5 g-xl-5">
                ...
                <div class="row g-2">
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="{{ route('careers') }}">Careers <span class="badge ms-1">we're hiring</span></a></li>
            ...
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0 quick-contact">
                ...
                <p class="d-flex mb-3">
                    ...
                    <span>123 Main Street Apt 4B Springfield, IL 62701 United States</span>
                </p>
...
<div class="row credits pt-3">
    <div class="col-xl-8 text-center text-xl-start mb-3 mb-xl-0">
        ...
        All rights reserved. Designed with ❤️ by <a href="https://freebootstrap.net ">FreeBootstrap.net</a>
    </div>
