<header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a class="navbar-brand w-auto" href="{{ url('/') }}">
            <img class="logo dark img-fluid" src="{{ asset('assets/images/logo-dark.svg') }}" alt="Logo Dark">
            <img class="logo light img-fluid" src="{{ asset('assets/images/logo-light.svg') }}" alt="Logo Light">
        </a>
